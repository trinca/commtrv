...
class CommunicationModels
{
    ...
    {
        static::$models[CommunicationMessage::class] = $model;
    }
    ...
    {
        static::$models[CommunicationParticipant::class] = $model;
    }
    ...
    {
        static::$models[CommunicationThread::class] = $model;
    }
    ...
    {
        return static::make(CommunicationMessage::class, $attributes);
    }
    ...
    {
        return static::make(CommunicationParticipant::class, $attributes);
    }
    ...
    {
        return static::make(CommunicationThread::class, $attributes);
    }
