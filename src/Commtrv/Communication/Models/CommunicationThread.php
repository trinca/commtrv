...
namespace Commtrv\Communication\Models;
...
class CommunicationThread extends Eloquent
{
    use SoftDeletes;
    ...
    {
        $this->table = CommunicationModels::table('threads');
    ...
    {
        return $this->hasMany(CommunicationModels::classname(CommunicationMessage::class), 'thread_id', 'id');
    }
    ...
    {
        return $this->hasMany(CommunicationModels::classname(CommunicationParticipant::class), 'thread_id', 'id');
    }
    ...
    {
        $participantsTable = CommunicationModels::table('participants');
        $threadsTable = CommunicationModels::table('threads');
    ...
    {
        $participantTable = CommunicationModels::table('participants');
        $threadsTable = CommunicationModels::table('threads');
    ...
    public function addParticipants(array $participants)
    {
        if (count($participants)) {
            foreach ($participants as $user_id) {
                CommunicationModels::participant()->firstOrCreate([
                    'user_id' => $user_id,
                    'thread_id' => $this->id,
                ]);
            }
    ...
    {
        $participantsTable = CommunicationsModels::table('participants');
        $usersTable = CommunicationsModels::table('users');
