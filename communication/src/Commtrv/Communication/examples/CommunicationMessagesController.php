...
class CommunicationMessagesController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $threads = CommunicationThread::getAllLatest()->get();
    ...
    {
        try {
            $thread = CommunicationThread::findOrFail($id);
    ...
    public function update($id)
    {
        ...
        $participant = CommunicationParticipant::firstOrCreate(
            [
                'thread_id' => $thread->id,
                'user_id'   => Auth::user()->id,
            ]
